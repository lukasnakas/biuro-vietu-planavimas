...
const DeleteRoomModal = (props) => {
  ...
  const deleteSelectedRoom = (event) => {
    props.deleteRoom(
      props.selectedRoomData.id,
      props.companyId,
                ...
                {deleteHappened ? (
                  props.deleteState === "success" ? (
                    ...
                    <div className="alert alert-danger" role="alert">
                      <strong>Užklausos atlikti nepavyko!</strong> Kabineto
                  ...
                  <h3>Ar tikrai norite ištrinti šio kabineto duomenis?</h3>
                )}
              </div>
            </div>
          </div>
